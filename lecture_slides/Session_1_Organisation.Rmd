...
output:
  ...
  beamer_presentation:
    includes:
      in_header: header.tex  # to include LaTeX footer definition
...
<h3>Introduction and organisational information <h3>
...
- Basic knowledge in working with R
  - For a refresher and more advanced materials, look at the [R-Introduction](https://discdown.org/rprogramming/) of Prof. Zeileis and colleagues.
